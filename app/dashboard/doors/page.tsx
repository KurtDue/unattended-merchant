                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    {doorStatus?.isLocked ? (
                      ...
                      <LockOpenIcon className="w-8 h-8 text-green-600 mr-3" />
                    )}
                    <div>
              ...
              <div className="text-center">
                ...
                >
                  {unlocking ? (
                    ...
                    <>
                      <LockOpenIcon className="w-6 h-6 mr-3" />
                      Unlock Front Door
                    </>
                  )}
                </button>
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <LockOpenIcon className="w-5 h-5 text-green-600 mr-2" />
